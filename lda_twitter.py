...
#tweets are stored in files in a directory named tweets
directory = 'tweets'
...
flat_list = [sub.replace('hong', 'hongkong') for sub in flat_list]     
flat_list = [sub.replace('kong', 'k') for sub in flat_list]  
