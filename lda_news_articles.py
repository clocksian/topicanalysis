...
print("Number of words is: ", len(flat_list)) 
...
flat_list = [word for word, pos in tags if (pos == 'VB' or pos == 'NN' or pos == 'NNP' or pos == "JJ")
]
...
"eastern", "part", "co", "realdonaldtrump", "thisisjustaride", "tastefullytayy", "vl0ko", "bymikebaker", "disneyland2go", "kong",
"president", "vice", "katie", "large", "coronavir", "full", "gangs"
 ])

stopwords.update([str(num) for num in range(0,10000)])
...
LDAvis_data_filepath = os.path.join('./ldavis_prepared_twitter2_'+str(number_topics))
...
pyLDAvis.save_html(LDAvis_prepared, './ldavis_prepared_twitter2_'+ str(number_topics) +'.html')
...
with open('outfile_twitter2', 'wb') as fp:
